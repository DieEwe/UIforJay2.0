  ...
  return <div className="min-h-screen flex">
      ...
      <aside className="w-[240px] bg-navy-light p-6 flex flex-col gap-8">
        ...
        <div className="flex items-center gap-2">
          <img src="/lovable-uploads/9d0e5bb4-ef8c-45d0-a96f-de1785ae0a73.png" alt="Logo" className="w-16 h-16 object-contain" />
        </div>
        ...
        {/* Theme Toggle */}
        <button onClick={() => setIsDarkMode(!isDarkMode)} className="w-10 h-10 rounded-lg bg-orange-400 hover:bg-orange-500 transition-colors flex items-center justify-center">
